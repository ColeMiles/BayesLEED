...
C
      INTEGER SSYM,LATMAT(2,2),KSYM(2,1000),NBSET(1000),KNB(20)          210492
      DIMENSION ARA1(2),ARA2(2),SPQF(2,1000),G(2,1000),GS1(2),GS2(2)
...
C---------------------------------------------------------------------------
     ...
     1SPQF,G,KNT,KSYM,NBSET,KNBS,KNB,RAR1,RAR2)
      INTEGER SSYM,LATMAT(2,2),KSYM(2,1000),NBSET(1000),KNB(20)         210492
      INTEGER SSYMA(2,1000),LSYMSA(2,1000)                              210492
      DIMENSION ARA1(2),ARA2(2),RAR1(2),RAR2(2),RBR1(2),RBR2(2)
      DIMENSION GDUMMY(2,1000)                                          210492
      DIMENSION ALMR(2,2),SPQF(2,1000),G(2,1000),ST(4),GU(2,12),GS(2,12)
     1,DG(2)
...
C  SIN(ALPHA) = SQRT(1-COS^2(ALPHA)                                     140291
      ...
      GMAX2=2.*EMAX/27.18+(ALOG(TST)/DMIN*0.529)**2
